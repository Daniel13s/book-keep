...
routesBook.post("/book", middleware, redisMiddleware, createBook.execute.bind(createBook))
...
routesBook.delete("/book/:id", middleware, redisMiddleware, deleteBook.execute.bind(deleteBook))